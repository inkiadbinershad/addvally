...
export const plans = [
  {
    id: 'starter', name: 'Starter', price: '₨4,999', yearlyPrice: '₨49,990',
    desc: 'For small shops just starting with digital ads',
    features: [
      { text: '1 active campaign', included: true },
      { text: 'Meta (Facebook + Instagram)', included: true },
      { text: 'AI ad copywriting', included: true },
  ...
  {
    id: 'growth', name: 'Growth', price: '₨12,999', yearlyPrice: '₨129,990',
    desc: 'For businesses scaling across all 3 platforms', featured: true,
    features: [
      ...
      { text: 'AI image generator', included: true },
      { text: 'Dedicated account manager', included: false },
    ],
  },
  {
    id: 'business', name: 'Business', price: '₨29,999', yearlyPrice: '₨299,990',
    desc: 'For multi-branch businesses and high-volume advertisers',
    features: [
      { text: 'Unlimited campaigns', included: true },
      { text: 'Meta + Google + TikTok', included: true },
      { text: 'Full AI content suite', included: true },
